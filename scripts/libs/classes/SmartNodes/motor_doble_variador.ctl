#uses "classes/SmartNodes/motor_doble"

class motor_doble_variador : motor_doble
{
  bool Xd_VF_OK;
  float Xr_Dato_1;
  float Xr_Dato_2;
  ...
  public void cambiarConsignaAutoAvance(float consigna)
  {
    setXt_TiempVigilancia_CM_F1(consigna);
  }

  public void cambiarConsignaAutoParo(float consigna)
  {
    setXt_TiempVigilancia_CP_F1(consigna);
  }

  public void cambiarConsignaManualAvance(float consigna)
  {
    setXt_TiempVigilancia_CM_F2(consigna);
  }

  public void cambiarConsignaManualParo(float consigna)
  {
    setXt_TiempVigilancia_CP_F2(consigna);
  }
};